...
export default function Faqs() {
    ...
    <section className="py-24">
        <div className="container">
            ...
            <h2 className="text-6xl font-medium mt-6 text-center mx-auto">Questions? We've got <span className="text-lime-400">answers</span></h2>
            <div className="mt-12 flex flex-col gap-6 mx-w-xl mx-auto">
                {faqs.map((faq,faqIndex)=>(
                    <div key={faq.question} className="bg-neutral-900 rounded-2xl border border-white/10 p-6">
                        <div className="flex justify-between items-center " onClick={() =>setselectedIndex(faqIndex)}>
                            ...
                            className={twMerge("feather feather-plus flex-shrink-0 text-lime-400 transition duration-300",selectedIndex==faqIndex && 'rotate-45')}><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                        </div>
                       <AnimatePresence>
